...
<head>
    ...
    <title>AI Hub</title>
    <link rel="shortcut icon" type="image/x-icon" href="assets/images/logo/aihub-logo.png">
    <!-- fontawesome 6.4.2 -->
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="header-top-one">
                            <div class="left-information">
                                <a href="mailto:someone@example.com" class="email"><i class="fa-light fa-envelope"></i>info@AIHub.com</a>
                                <a href="tel:+4733378901" class="email"><i class="fa-light fa-phone"></i>+234 012 012 445</a>
                            </div>
                    ...
                    <div class="header-one-wrapper">
                        <div class="left-side-header">
                            <a href="index-2.html" class="logo-area">
                                <img src="assets/images/logo/aihub-logo.png" width="80px" alt="logo">
                            </a>
    ...
    <div class="banner-area-one shape-move">
        ...
        <div class="shape-image">
            <div class="shape one" data-speed="0.04" data-revert="true"><img src="assets/images/banner/shape/banner-shape01.svg" alt="shape_image"></div>
            <div class="shape two" data-speed="0.04"><img src="assets/images/banner/shape/banner-shape02.svg" alt="shape_image"></div>
            <div class="shape three" data-speed="0.04"><img src="assets/images/banner/shape/banner-shape03.svg" alt="shape_image"></div>
        </div>
    </div>
    <!-- banner area end -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-12 pl--60 pl_lg--15 pl_md--10 pl_sm--10 pt_lg--50 pt_md--50 pt_sm--50">
                    <div class="title-area-left-style">
                        ...
                        <h2 class="title">Know AI Hub Empowering
                        ...
                        <div class="author-area">
                            <div class="single-author-and-info">
                                ...
                                <div class="information">
                                    ...
                                    <p class="desig">CEO, AI Hub Online Education</p>
                                </div>
                            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pl--90 pl_md--15 mt_md--50 pl_sm--15 pt_sm--50">
                    <div class="title-area-left-style">
                        ...
                        <h2 class="title">AI Hub Your Path to
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-sction bg_image shape-move">
                        <h2 class="title">Skills Certificate From <br> the AI Hub</h2>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-area-one">
                            <p>Copyright © 2024 All Rights Reserved by Ai HUB</p>
